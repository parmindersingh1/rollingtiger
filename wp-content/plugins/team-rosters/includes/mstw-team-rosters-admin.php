...
//
	...
	function mstw_tr_create_ui( $post ) {						  
	   ...
	   <table class="form-table">
		...
		<tr valign="top">
			<th scope="row"><label for="mstw_tr_year" >Date OF Birth:</label></th>
			<td><input maxlength="64" size="8" name="mstw_tr_year"
        	value="<?php echo esc_attr( $year ); ?>"/></td>
		</tr>
		<tr valign="top">
			<th scope="row"><label for="mstw_tr_experience" >Class:</label></th>
		...
		<tr valign="top">
			<th scope="row"><label for="mstw_tr_last_school" >School:</label></th>
			<td><input maxlength="64" size="20" name="mstw_tr_last_school"
        	value="<?php echo esc_attr( $last_school ); ?>"/></td>
		</tr>
		<tr valign="top">
			<th scope="row"><label for="mstw_tr_country" >Category:</label></th>
